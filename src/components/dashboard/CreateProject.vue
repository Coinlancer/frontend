<script>
  ...
  export default {
    ...
    created () {
      ...
      vm.$store.dispatch('getSubCategories');
...
//                return vm.$helpers.errorMsg('Can not create project');
//              }
//              vm.$router.push('/dashboard/projects/edit/' + project.prj_id);
...
//      },
      ...
      getChildrenCategories: function (parent_cat) {
        let vm = this;
        let child_categories = this.$store.getters.getChildCategories;
        vm.child_categories = [];
